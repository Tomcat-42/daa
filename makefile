...
default:  libdaa test main daa

all:  libdaa test main daa

.PHONY: default all  libdaa test main daa

libdaa: build/linux/x86_64/release/libdaa.a
build/linux/x86_64/release/libdaa.a: build/.objs/libdaa/linux/x86_64/release/src/libdaa/sorting/quicksort.cpp.o
	@echo linking.release libdaa.a
	@mkdir -p build/linux/x86_64/release
	@$(AR) $(libdaa_ARFLAGS) build/linux/x86_64/release/libdaa.a build/.objs/libdaa/linux/x86_64/release/src/libdaa/sorting/quicksort.cpp.o > build/.build.log 2>&1
...
build/linux/x86_64/release/main: build/linux/x86_64/release/libdaa.a build/.objs/main/linux/x86_64/release/src/main.cpp.o
...
build/linux/x86_64/release/daa.so: build/linux/x86_64/release/libdaa.a build/.objs/daa/linux/x86_64/release/src/daa/sorting/quicksort.cpp.o
...
clean:  clean_libdaa clean_test clean_main clean_daa

clean_libdaa: 
	@rm -rf build/linux/x86_64/release/libdaa.a
